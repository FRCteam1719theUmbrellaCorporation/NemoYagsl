...
public class AwfulGyroWrapper extends SwerveIMU {
   ...
   */
  public AwfulGyroWrapper(int canid, String canbus) {
    imu = new HarrisonsAwfulGyro(canid, canbus);
   ...
   * @param canid CAN ID for the {@link Pigeon2}
   */
  public AwfulGyroWrapper(int canid) {
    this(canid, "");
  }
