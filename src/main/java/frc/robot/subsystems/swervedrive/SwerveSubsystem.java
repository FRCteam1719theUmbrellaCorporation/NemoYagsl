...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  //ADDED FOR APRIL TAG POSES

  // creates a translation 2d from an angle 
  public Translation2d constructTranslationPose(double x, double y) {
        return new Translation2d(x,y);
    }

  // creates a rotation 2d from an angle
  public Rotation2d constructRotationPose(double angle) {
      return new Rotation2d(angle);
  }

  // creates a pos from a translation2d and a rotation 2d
  ...
  // returns the pos at which the robot should move to
